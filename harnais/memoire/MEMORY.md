...
- [rollup_annonces](rollup_annonces.md) — **annonces de l'administration** (2026-08-15) : collection `annonces`, popup d'envoi dans /admin, cloche refondue (lu par notification, chaque notification mène à ce qu'elle annonce) — **livré, non testé**
